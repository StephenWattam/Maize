...
\frame{\frametitle{Demos}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item<6-> GraphBot is \texttt{very} stateful
        \end{itemize}
    \end{itemize}
}
...
\frame{\frametitle{The Life of a Bot}
    \begin{itemize}
        ...
        \vspace{15pt}
        \item<7-> Bots can move only \textbf{one tile per `tick'}, and only \textbf{Left}, \textbf{Right}, \textbf{Forward} and \textbf{Back} (like kings in chess)
    \end{itemize}
}
...
\frame{\frametitle{Challenges}
    \begin{enumerate}
        ...
        \vspace{3pt}
        \item<5-> Beat Gorad or GraphBot
        \vspace{3pt}
        \item<6-> Beat the security manager ;-)
    \end{enumerate}
}
...
\frame{\frametitle{Getting Started (concrete)}
    \begin{itemize}
        ...
        \vspace{10pt}
        \item<3-> Edit your bot and select \texttt{Bots > Compile...} or \texttt{Bots > Compile/reload all} to recompile.
        \vspace{10pt}
