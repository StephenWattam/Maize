...
\frame{\frametitle{Aims \& Objectives}
    \begin{itemize}
        ...
        \item<2-> But they're also useful at a higher level
    \end{itemize}
}
...
\frame{\frametitle{Automata in the Real World}
    \begin{itemize}
        \item Higher-level uses of automata: model the world
...
\frame{\frametitle{Embedded and SCADA}
    \begin{itemize}
        \item Changes observed (stream of information)
        
        % Measure-model-control
        % Show world modelling diagram
        %
...
\frame{\frametitle{FSM Bots}
    ...
    \vspace{5pt}
    \begin{center}
        \includegraphics[width=5cm]{botfsm1}
    \end{center}
}
