...
\documentclass[xcolor=x11names,xcolor=table,compress,handout]{beamer} % handout to disable transitions
...
\frame{\frametitle{Networking}
    ...
    {\small \texttt{http://www.tcpipguide.com}}
}
...
\frame{\frametitle{Gaming \& AI}
    ...
    \end{center}
    {\small \texttt{http://gameprogrammingpatterns.com/state.html\\
